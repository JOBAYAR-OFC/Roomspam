...
from JXE import openroom, spmroom
...
def home():
    ...
    <p>Endpoints Available endpoints:</p>
    <ul>
        <li><strong>بStart spam:</strong> GET /spam?user_id=123456789&amp;duration=5 (duration اختياري - بالدقائق)</li>
        <li><strong>Stop:</strong> GET /stop?user_id=123456789</li>
        <li><strong>status:</strong> GET /status</li>
        <li><strong>account check:</strong> GET /accounts</li>
    </ul>
    <p><strong>ملاحظة:</strong> النظام المحدث يقوم بفتح روم أولاً ثم إرسال السبام عبر جميع الحسابات.</p>
    """

def run_api():
    print("🌐 Start Room spam API...")
